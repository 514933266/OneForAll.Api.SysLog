    ...
    public class ApiLogMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            var data = new SysApiLogForm()
            {
                ...
                TenantId = loginUser.TenantId.ToString(),
        ...
        private LoginUser GetLoginUser(HttpContext context)
        {
            ...
            var nameClaim = claims.FirstOrDefault(e => e.Type == UserClaimType.DisplayName);
            ...
            {
                Id = userIdClaim?.Value == null ? Guid.Empty.ToString() : userIdClaim.Value.ToString(),
                DisplayName = nameClaim?.Value ?? "无",
                TenantId = tenantIdClaim?.Value == null ? Guid.Empty.ToString() : tenantIdClaim.Value.ToString(),
                IsDefault = isDefaultClaim?.TryBoolean() ?? false
            };
        }
    }
}